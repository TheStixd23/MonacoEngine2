 ...
 * @brief Declaración de la clase DeviceContext, encargada de administrar el contexto inmediato de Direct3D 11.
 * @details Facilita la configuración de estados del pipeline, asignación de shaders, buffers, samplers y ejecución de comandos de renderizado.
 * @author Hannin
 */

 /**
  * @class DeviceContext
  * @brief Encapsula un @c ID3D11DeviceContext para manejar la configuración del pipeline de render y ejecutar comandos de dibujo en Direct3D 11.
  *
  * Esta clase proporciona una interfaz simplificada para el uso del contexto inmediato de Direct3D 11.
  * Permite:
  * - Configurar viewports, shaders, samplers y estados de render.
  * - Asignar buffers y recursos a distintas etapas del pipeline.
  * - Ejecutar comandos de dibujo como @c DrawIndexed().
  *
  */
class DeviceContext {
public:
